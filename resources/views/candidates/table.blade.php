    ...
    @foreach($candidates as $candidate)
        <tr>
            ...
            <td>
                ...
                <div class='btn-group'>
                    <a href="{!! route('candidates.show', [$candidate['co_author_id']]) !!}" class='btn btn-default btn-xs'><i class="fa fa-eye"></i></a>
                    <a href="{!! route('candidates.edit', [$candidate['co_author_id']]) !!}" class='btn btn-default btn-xs'><i class="fa fa-edit"></i></a>
